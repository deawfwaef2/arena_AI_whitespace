...
export const AUCTION_LOTS = [
 ...
 { id: 'auc-strad', name: pair('Stradivarius 1716 Messiah','《1716年斯特拉迪瓦里“弥赛亚”名琴》'), price: 180000000, points: 90, upkeep: 90000, medal: '🎻', desc: pair('Pristine golden violin embodying the summit of classical acoustics.','小提琴制造史巅峰之作，枫木背板流淌着三个世纪的典雅回响。'), tier: 4 },
 { id: 'auc-wine', name: pair('DRC Romanee-Conti 1945','《1945年罗曼尼·康帝特级年份珍藏》'), price: 250000000, points: 130, upkeep: 120000, medal: '🍷', desc: pair('Mythical post-war vintage Burgundy, the rarest liquid gold in existence.','传世战后绝版年份佳酿，全球存世仅两瓶的纯粹液体黄金。'), tier: 4 },
 ...
 { id: 'auc-egg', name: pair('Fabergé Imperial Coronation Egg','《法贝热沙皇加冕复活节彩蛋》'), price: 550000000, points: 280, upkeep: 280000, medal: '🪺', desc: pair('Enamelled imperial masterpiece concealing a miniature gold coronation carriage.','沙皇御用珐琅黄金彩蛋，内置可拆卸纯金微雕加冕双轮马车。'), tier: 5 },
 ...
 { id: 'auc-castle', name: pair('Black Swan Rhine Castle Domain','《莱茵河畔黑天鹅古堡全境领地》'), price: 1800000000, points: 900, upkeep: 900000, medal: '🏰', desc: pair('Eight-century fortified dukedom complete with vineyards and sovereign heraldry.','横跨八百年的私有世袭公爵领地，附带私家葡萄园与主权纹章。'), tier: 5 },
 ...
 { id: 'auc-crown', name: pair('Solar Peacock Gold Crown','《莫卧儿日耀纯金孔雀王冠》'), price: 5000000000, points: 2600, upkeep: 2500000, medal: '👑', desc: pair('Magnificent imperial diadem studded with 120 pigeon-blood rubies and emeralds.','镶嵌 120 颗鸽血红宝石与哥伦比亚祖母绿的帝王冠冕，璀璨夺目。'), tier: 6 },
 ...
 { id: 'auc-shuttle', name: pair('Orbital Private Shuttle Vessel','《亚轨道极速私人航天穿梭机》'), price: 18000000000, points: 9500, upkeep: 9000000, medal: '🛸', desc: pair('Mach-12 supersonic sub-orbital craft fitted with starlight observation dome.','12马赫亚轨道极速空天穿梭机，配有全景星光穹顶与反重力座舱。'), tier: 6 },
 ...
 { id: 'auc-atoll', name: pair('Sovereign Coral Atoll Realm','《南太平洋私有主权环礁岛国》'), price: 55000000000, points: 30000, upkeep: 28000000, medal: '🏝️', desc: pair('Autonomous oceanic territory with sovereign diplomacy and fiscal immunity.','拥有独立外交豁免权与永久免税主权的深海环礁，独享蔚蓝海疆。'), tier: 7 },
 { id: 'auc-emperor', name: pair('Augustus Gold Laurel','《古罗马奥古斯都纯金桂冠》'), price: 100000000000, points: 50000, upkeep: 50000000, medal: '🏛️', desc: pair('Millennium-old golden imperial laurel wreath representing the zenith of power.','千年前帝国权杖之巅的纯金桂冠，至高威严与永恒权力的最终象征。'), tier: 7 },
 { id: 'auc-yacht', name: pair('Nuclear Polar Superyacht','《180米核动力极地破冰巨型游艇》'), price: 250000000000, points: 130000, upkeep: 120000000, medal: '🚢', desc: pair('Floating sovereign fortress capable of perpetual autonomous circumnavigation.','征服七大海域与南北两极的终极浮动行宫，具备无限续航与私人机库。'), tier: 7 }
];
export const TIERS=[
