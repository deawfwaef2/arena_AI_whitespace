...
export class V12{
 ...
 stakeTxt(o){const S=X.CITY_STYLE[o.city]||{};const st=o.stake;let up=o.up;if(S.lever)up=+(o.up+.6*((st-o.min)/Math.max(1,o.max-o.min))).toFixed(2);return {v:this.money(st),w:'+'+this.money(Math.floor(st*up)-st)+' (×'+up+')',l:'−'+this.money(S.half?Math.floor(st/2):st)};}
