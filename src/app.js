...
window.__r14world=world;window.__r14music=music;
...
document.addEventListener('click',e=>{const b=e.target.closest?.('button,[data-action],[role=button],.menu-tile,a[href]');if(!b||b.disabled)return;const a=b.dataset?.action||'';
